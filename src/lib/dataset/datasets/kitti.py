...
class KITTI(GenericDataset):
  ...
  # num_categories = 1
  # class_name = ['Car']
  # cat_ids = {1:-9999, 2:1, 3:-9999, 4:-1, 5:-1, 6:-9999, 7:-9999, 8:-9999, 9:0}  # car only
  ...
  def __init__(self, opt, split):
    ...
    if opt.trainval:
      ...
      # img_dir = os.path.join(data_dir, 'raw', '2011_09_26_drive_0106_sync', 'image_02', 'data')
  ...
  def run_eval(self, results, save_dir):
    ...
    # print('Results of IoU threshold 0.7, ap11')
    # os.system('./tools/kitti_eval/evaluate_object_3d_offline_ap11_07 ' + \
    #           '../data/kitti/training/label_val ' + \
    #           '{}/results_kitti/'.format(save_dir))
    print('Results of IoU threshold 0.7, ap40')
    os.system('./tools/kitti_eval/evaluate_object_3d_offline_ap40_07 ' + \
              '../data/kitti/training/label_val ' + \
              '{}/results_kitti/'.format(save_dir))
    # print('Results of IoU threshold 0.5, ap11')
    # os.system('./tools/kitti_eval/evaluate_object_3d_offline_ap11_05 ' + \
    #           '../data/kitti/training/label_val ' + \
    #           '{}/results_kitti/'.format(save_dir))
